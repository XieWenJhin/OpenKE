...
if __name__ == "__main__":
    ...
    if args.model == "complex":
        ...
        model.load_checkpoint('./checkpoint/dbpedia_complex.ckpt')
    ...
    neg_fdst = pd.read_csv('/home/LAB/xiewj/neural-mining/datasets/dbpedia/test_neg_per_dst/test_neg_5.csv')
