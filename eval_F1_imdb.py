...
if __name__ == "__main__":
    ...
    if args.model == "complex":
        ...
        model.load_checkpoint('./checkpoint/imdb_rotate.ckpt')
    model = model.cuda()
    pos = pd.read_csv('/home/LAB/xiewj/neural-mining/datasets/imdb/test_edges.csv')
    neg_fsrc = pd.read_csv('/home/LAB/xiewj/neural-mining/datasets/imdb/test_neg_per_src/test_neg_1.csv')
    neg_fdst = pd.read_csv('/home/LAB/xiewj/neural-mining/datasets/imdb/test_neg_per_dst/test_neg_1.csv')
